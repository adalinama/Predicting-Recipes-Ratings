...
We proceeded to explore alternative approaches to improve the model's performance. Next, we explored how a RandomForestRegressor impacted the model. The best hyperparameter found using grid search revealed a maximum depth of 3 for each decision tree using 100 estimators. After running this, the training set RMSE was 0.3365 and R-squared value was 0.01659. For the test set, we got an RMSE of 0.3144 and R-squared score of -0.0019. We were still unsatisfied with these results because there was not much improvement from the Baseline Model.
